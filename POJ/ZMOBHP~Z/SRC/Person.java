...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>NativeEventDemo/src/Person.java at master · Tokiya/NativeEventDemo · GitHub</title>
...
<meta content="6IbvtCtU39TB0bwCzhycwO247I0A6oxkkglFGL3ke+g=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-21be1ddb6396c340f389430eb4f465e34b778329.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="e6f5dd9ec79a3f28962f9ad2031aacbb">
        ...
        <link data-pjax-transient rel='permalink' href='/Tokiya/NativeEventDemo/blob/a9bfb9e079cdfa06d1e5c41ea74072943bcbe942/src/Person.java'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="/login?return_to=%2FTokiya%2FNativeEventDemo%2Fblob%2Fmaster%2Fsrc%2FPerson.java">Sign in</a>
    </div>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Tokiya/NativeEventDemo/blob/master/src/Person.java" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:e83aa9fe394057d61bb7aad95d20612f -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:e83aa9fe394057d61bb7aad95d20612f -->
...
<div id="slider">
  ...
  <div class="commit file-history-tease">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/Tokiya/NativeEventDemo/blob/a9bfb9e079cdfa06d1e5c41ea74072943bcbe942/src/Person.java" data-title="NativeEventDemo/src/Person.java at master · Tokiya/NativeEventDemo · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/Tokiya/NativeEventDemo/raw/master/src/Person.java" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/Tokiya/NativeEventDemo/blame/master/src/Person.java" class="button minibutton ">Blame</a>
                  <a href="/Tokiya/NativeEventDemo/commits/master/src/Person.java" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L31" rel="#L31">31</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><br/></div><div class='line' id='LC2'><span class="kd">public</span> <span class="kd">class</span> <span class="nc">Person</span> <span class="kd">implements</span> <span class="n">PetListener</span><span class="o">{</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'>	<span class="kd">private</span> <span class="n">String</span> <span class="n">name</span><span class="o">;</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'>	<span class="kd">public</span> <span class="nf">Person</span><span class="o">(</span><span class="n">String</span> <span class="n">name</span><span class="o">)</span></div><div class='line' id='LC7'>	<span class="o">{</span></div><div class='line' id='LC8'>		<span class="k">this</span><span class="o">.</span><span class="na">name</span><span class="o">=</span><span class="n">name</span><span class="o">;</span></div><div class='line' id='LC9'>	<span class="o">}</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'>	<span class="nd">@Override</span></div><div class='line' id='LC12'>	<span class="kd">public</span> <span class="kt">void</span> <span class="nf">petHungry</span><span class="o">(</span><span class="n">PetEvent</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC13'>		<span class="n">System</span><span class="o">.</span><span class="na">out</span><span class="o">.</span><span class="na">println</span><span class="o">(</span><span class="n">name</span> <span class="o">+</span> <span class="s">&quot; karmi &quot;</span><span class="o">+</span> <span class="n">e</span><span class="o">.</span><span class="na">getPet</span><span class="o">().</span><span class="na">getName</span><span class="o">()</span> <span class="o">);</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'>	<span class="o">}</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'>	<span class="nd">@Override</span></div><div class='line' id='LC18'>	<span class="kd">public</span> <span class="kt">void</span> <span class="nf">petBored</span><span class="o">(</span><span class="n">PetEvent</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'>		<span class="n">System</span><span class="o">.</span><span class="na">out</span><span class="o">.</span><span class="na">println</span><span class="o">(</span><span class="n">name</span> <span class="o">+</span> <span class="s">&quot; bawi się z &quot;</span><span class="o">+</span> <span class="n">e</span><span class="o">.</span><span class="na">getPet</span><span class="o">().</span><span class="na">getName</span><span class="o">()</span> <span class="o">);</span></div><div class='line' id='LC21'><br/></div><div class='line' id='LC22'>	<span class="o">}</span></div><div class='line' id='LC23'><br/></div><div class='line' id='LC24'>	<span class="nd">@Override</span></div><div class='line' id='LC25'>	<span class="kd">public</span> <span class="kt">void</span> <span class="nf">petDirty</span><span class="o">(</span><span class="n">PetEvent</span> <span class="n">e</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'>		<span class="n">System</span><span class="o">.</span><span class="na">out</span><span class="o">.</span><span class="na">println</span><span class="o">(</span><span class="n">name</span> <span class="o">+</span> <span class="s">&quot; daje kąpiel &quot;</span><span class="o">+</span> <span class="n">e</span><span class="o">.</span><span class="na">getPet</span><span class="o">().</span><span class="na">getName</span><span class="o">());</span></div><div class='line' id='LC28'><br/></div><div class='line' id='LC29'>	<span class="o">}</span></div><div class='line' id='LC30'><br/></div><div class='line' id='LC31'><span class="o">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.04290s from fe1.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
    <a class="left" href="/">
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.04329' data-host='fe1'></span>
