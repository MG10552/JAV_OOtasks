...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>LibraryProject/src/model/Author.java at master · Tokiya/LibraryProject · GitHub</title>
...
<meta content="6IbvtCtU39TB0bwCzhycwO247I0A6oxkkglFGL3ke+g=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-21be1ddb6396c340f389430eb4f465e34b778329.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="e6f5dd9ec79a3f28962f9ad2031aacbb">
        ...
        <link data-pjax-transient rel='permalink' href='/Tokiya/LibraryProject/blob/643046e5e2c4012e2591dce3d69e8807f754ab7a/src/model/Author.java'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="/login?return_to=%2FTokiya%2FLibraryProject%2Fblob%2Fmaster%2Fsrc%2Fmodel%2FAuthor.java">Sign in</a>
    </div>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/Tokiya/LibraryProject/blob/master/src/model/Author.java" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:ca659f63b65e5b85cab6e4c608302fa1 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:ca659f63b65e5b85cab6e4c608302fa1 -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/Tokiya/LibraryProject/blob/643046e5e2c4012e2591dce3d69e8807f754ab7a/src/model/Author.java" data-title="LibraryProject/src/model/Author.java at master · Tokiya/LibraryProject · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/Tokiya/LibraryProject/raw/master/src/model/Author.java" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/Tokiya/LibraryProject/blame/master/src/model/Author.java" class="button minibutton ">Blame</a>
                  <a href="/Tokiya/LibraryProject/commits/master/src/model/Author.java" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L28" rel="#L28">28</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="kn">package</span> <span class="n">model</span><span class="o">;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="kd">public</span> <span class="kd">class</span> <span class="nc">Author</span> <span class="o">{</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'>	<span class="kd">private</span> <span class="n">String</span> <span class="n">name</span><span class="o">;</span></div><div class='line' id='LC6'>	<span class="kd">private</span> <span class="n">String</span> <span class="n">surname</span><span class="o">;</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'>	<span class="kd">public</span> <span class="n">String</span> <span class="nf">toString</span><span class="o">()</span></div><div class='line' id='LC9'>	<span class="o">{</span></div><div class='line' id='LC10'>		<span class="k">return</span> <span class="s">&quot;Imie: &quot;</span><span class="o">+</span><span class="k">this</span><span class="o">.</span><span class="na">name</span><span class="o">+</span><span class="s">&quot;\n&quot;</span> <span class="o">+</span></div><div class='line' id='LC11'>				<span class="s">&quot;Nazwisko: &quot;</span> <span class="o">+</span><span class="k">this</span><span class="o">.</span><span class="na">surname</span><span class="o">;</span></div><div class='line' id='LC12'>	<span class="o">}</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'>	<span class="kd">public</span> <span class="n">String</span> <span class="nf">getName</span><span class="o">()</span> <span class="o">{</span></div><div class='line' id='LC15'>		<span class="k">return</span> <span class="n">name</span><span class="o">;</span></div><div class='line' id='LC16'>	<span class="o">}</span></div><div class='line' id='LC17'>	<span class="kd">public</span> <span class="kt">void</span> <span class="nf">setName</span><span class="o">(</span><span class="n">String</span> <span class="n">name</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC18'>		<span class="k">this</span><span class="o">.</span><span class="na">name</span> <span class="o">=</span> <span class="n">name</span><span class="o">;</span></div><div class='line' id='LC19'>	<span class="o">}</span></div><div class='line' id='LC20'>	<span class="kd">public</span> <span class="n">String</span> <span class="nf">getSurname</span><span class="o">()</span> <span class="o">{</span></div><div class='line' id='LC21'>		<span class="k">return</span> <span class="n">surname</span><span class="o">;</span></div><div class='line' id='LC22'>	<span class="o">}</span></div><div class='line' id='LC23'>	<span class="kd">public</span> <span class="kt">void</span> <span class="nf">setSurname</span><span class="o">(</span><span class="n">String</span> <span class="n">surname</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC24'>		<span class="k">this</span><span class="o">.</span><span class="na">surname</span> <span class="o">=</span> <span class="n">surname</span><span class="o">;</span></div><div class='line' id='LC25'>	<span class="o">}</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><br/></div><div class='line' id='LC28'><span class="o">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.10316s from fe19.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
    <a class="left" href="/">
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.10355' data-host='fe19'></span>
