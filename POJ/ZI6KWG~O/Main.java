...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>ThreadDeom/src/Main.java at master · Tokiya/ThreadDeom · GitHub</title>
...
<meta content="6IbvtCtU39TB0bwCzhycwO247I0A6oxkkglFGL3ke+g=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-ab0d668c4e85d800512d0a4597c0821632736ae6.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="abf9b8fa5fc699ddca81c0758ac5ff03">
        ...
        <link data-pjax-transient rel='permalink' href='/Tokiya/ThreadDeom/blob/a3a7770e9d6e85c90b0a78ba398ae8b8ffe52e51/src/Main.java'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="https://github.com/login?return_to=%2FTokiya%2FThreadDeom%2Fblob%2Fmaster%2Fsrc%2FMain.java">Sign in</a>
    </div>
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item selected">
                  ...
                  <a href="/Tokiya/ThreadDeom/blob/master/src/Main.java" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
...
<!-- blob contrib key: blob_contributors:v21:10c57fc6deed0848aa852cfdf46941cc -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:10c57fc6deed0848aa852cfdf46941cc -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/Tokiya/ThreadDeom/blob/a3a7770e9d6e85c90b0a78ba398ae8b8ffe52e51/src/Main.java" data-title="ThreadDeom/src/Main.java at master · Tokiya/ThreadDeom · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/Tokiya/ThreadDeom/raw/master/src/Main.java" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/Tokiya/ThreadDeom/blame/master/src/Main.java" class="button minibutton ">Blame</a>
                  <a href="/Tokiya/ThreadDeom/commits/master/src/Main.java" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L22" rel="#L22">22</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><br/></div><div class='line' id='LC2'><span class="kd">public</span> <span class="kd">class</span> <span class="nc">Main</span> <span class="o">{</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'>	<span class="kd">public</span> <span class="kd">static</span> <span class="kt">void</span> <span class="nf">main</span><span class="o">(</span><span class="n">String</span><span class="o">[]</span> <span class="n">args</span><span class="o">)</span> <span class="kd">throws</span> <span class="n">InterruptedException</span></div><div class='line' id='LC5'>	<span class="o">{</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'>		<span class="n">IntPrinter</span> <span class="n">p</span> <span class="o">=</span> <span class="k">new</span> <span class="n">IntPrinter</span><span class="o">();</span></div><div class='line' id='LC8'>		<span class="n">Thread</span> <span class="n">t</span> <span class="o">=</span> <span class="k">new</span> <span class="n">Thread</span><span class="o">(</span><span class="n">p</span><span class="o">);</span></div><div class='line' id='LC9'>		<span class="n">System</span><span class="o">.</span><span class="na">out</span><span class="o">.</span><span class="na">println</span><span class="o">(</span><span class="s">&quot;Main działa na wątku o id:&quot;</span><span class="o">+</span></div><div class='line' id='LC10'>				<span class="n">Thread</span><span class="o">.</span><span class="na">currentThread</span><span class="o">().</span><span class="na">getId</span><span class="o">());</span></div><div class='line' id='LC11'>		<span class="n">t</span><span class="o">.</span><span class="na">start</span><span class="o">();</span></div><div class='line' id='LC12'>		<span class="n">Thread</span> <span class="n">t2</span> <span class="o">=</span> <span class="k">new</span> <span class="n">Thread</span><span class="o">(</span><span class="n">p</span><span class="o">);</span></div><div class='line' id='LC13'>		<span class="n">t2</span><span class="o">.</span><span class="na">start</span><span class="o">();</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'><span class="c1">//		while(p.isRunning)</span></div><div class='line' id='LC17'><span class="c1">//		{</span></div><div class='line' id='LC18'><span class="c1">//			System.out.print(&quot;.&quot;);</span></div><div class='line' id='LC19'><span class="c1">//			Thread.sleep(100);</span></div><div class='line' id='LC20'><span class="c1">//		}</span></div><div class='line' id='LC21'>	<span class="o">}</span></div><div class='line' id='LC22'><span class="o">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.10513s from fe13.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.10553' data-host='fe13'></span>
